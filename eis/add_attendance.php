...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="tb3_colunm8" rows="5"></textarea></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="top">Picture:</td>
      <td>
      <textarea name="tb3_colunm9" rows="1" readonly>upload/61f71be1c022d.png</textarea>
      </td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="top">Location:</td>
      <td>
      <textarea id="gps" name="tb3_colunm10" rows="1" readonly></textarea>
      </td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="tb3_colunm1" value="<?php echo $_GET['user_id'] ?>" />
...
function showError(error) {
  switch(error.code) {
    ...
    case error.UNKNOWN_ERROR:
      x.innerHTML = "Device dont support GPS"
      break;
  }
}
</script>
