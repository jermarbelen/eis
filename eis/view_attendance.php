...
<?php if ($totalRows_rstable3 == 0 && $row_rsusers['user_id'] == NULL) { ?>
	<p>Sorry we cant find your ID. Please try again <a href="login.php">here</a> or <br/> if its your first time seeing this page, please create your account <a href="index.php?group=2">here</a>.</p>
