...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="tb3_colunm1" value="<?php echo htmlentities($row_rstable3['tb3_colunm1'], ENT_COMPAT, 'utf-8'); ?>" required readonly /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date:</td>
      <td><input type="date" name="tb3_colunm2" value="<?php echo htmlentities($row_rstable3['tb3_colunm2'], ENT_COMPAT, 'utf-8'); ?>" required readonly /></td>
    </tr>
    <tr <?php if ($_GET['action'] != Attend) { ?>hidden<?php } ?> valign="baseline">
      <td nowrap="nowrap" align="right">Attend:</td>
      <td><input type="text" name="tb3_colunm3" value="<?php if ($_GET['action'] == Attend && $row_rstable3 == NULL) {echo date('H:i');} else{ echo htmlentities($row_rstable3['tb3_colunm3'], ENT_COMPAT, 'utf-8'); } ?>" required readonly /></td>
    </tr>
    <tr <?php if ($_GET['action'] != OUT) { ?>hidden<?php } ?> valign="baseline">
      <td nowrap="nowrap" align="right">OUT:</td>
      <td><input type="text" name="tb3_colunm4" value="<?php if ($_GET['action'] == OUT && $row_rstable4 == NULL) {echo date('H:i');} else{ echo htmlentities($row_rstable3['tb3_colunm4'], ENT_COMPAT, 'utf-8'); } ?>"  readonly /></td>
    </tr>
    <tr <?php if ($_GET['action'] != IN) { ?>hidden<?php } ?> valign="baseline">
      <td nowrap="nowrap" align="right">IN:</td>
      <td><input type="text" name="tb3_colunm5" value="<?php if ($_GET['action'] == IN && $row_rstable5 == NULL) {echo date('H:i');} else{ echo htmlentities($row_rstable3['tb3_colunm5'], ENT_COMPAT, 'utf-8'); } ?>"  readonly /></td>
    </tr>
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="tb3_colunm8" rows="5" required><?php echo htmlentities($row_rstable3['tb3_colunm8'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
    </tr>
    </tr>
    <tr valign="baseline">
